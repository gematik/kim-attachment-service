...
public class KasHttpTraceRepository implements HttpTraceRepository {
    ...
    public void add(HttpTrace trace) {
        log.info(
            "Request:: uri: " + trace.getRequest().getUri() + " - method: " + trace.getRequest().getMethod() + " - headers: " + trace.getRequest()
                .getHeaders());
        log.info("Response:: status: " + trace.getResponse().getStatus() + " - headers: " + trace.getRequest().getHeaders());
